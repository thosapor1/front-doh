...
export default async function PdfPaymentDaily(selectedDate, checkpoint) {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        pdfMake
          ...
          .download("รายงานสรุปPaymentgประจำวัน.pdf", () => {
            resolve();
          });
      } catch (err) {
        reject(err);
  ...
  let docDefinition = {
    ...
    content: [
      ...
      {
        text: "เอกสาร ตรวจสอบความถูกต้องของ Payment ประจำวัน",
        fontSize: 14,
      },
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              {
                text: res.data.result_payment[0].count_payment.toLocaleString(),
              },
              {
                text: res.data.result_payment[0].sum_fee_totalAmount.toLocaleString(),
              },
            ],
          ],
        },
